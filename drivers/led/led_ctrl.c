...
led_control_inst led_dev_control = {
    ...
    {POWER_RED, POWER_RED_SELECTOR, STATUS_LED_OFF, 0, 0, 0},//pull up active

    {NET_GREEN, NET_GREEN_SELECTOR, STATUS_LED_OFF, 0, 0, 0},
    ...
    {WIFIA_GREEN, WIFIA_GREEN_SELECTOR, STATUS_LED_OFF, 0, 0, 0},
