...
#if defined(CONFIG_ROUTER_MERCURY_MAC2600R)
#define RALINK_GPIOMODE_DFT		(RALINK_GPIOMODE_UART3 | RALINK_GPIOMODE_GE2) 
#elif defined(CONFIG_ROUTER_ZTE_E8820V2)
#define RALINK_GPIOMODE_DFT		(RALINK_GPIOMODE_WDT | RALINK_GPIOMODE_GE2) 
#else
